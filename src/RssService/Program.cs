...
// `dotnet run --project src/RssService -- --init-db` creates every Cosmos DB (Mongo API) collection/index
...
// nested JSON shape already used here for CosmosDb secrets keep working as-is in production,
