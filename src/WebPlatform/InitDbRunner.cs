...
/// CosmosIndexInitializerHostedService) so every Cosmos DB (Mongo API) collection/index is created
/// without ever starting Kestrel/Hangfire. Sole ServiceProvider built in this mode - the caller returns
...
#pragma warning restore ASP0000
        ...
        initLogger.LogInformation("--init-db: creating Cosmos DB (Mongo API) collections/indexes only");
