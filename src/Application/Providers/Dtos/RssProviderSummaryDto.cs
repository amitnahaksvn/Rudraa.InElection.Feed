...
public sealed record RssFeedSummaryDto(string Id, string Name, string Url, string Category, string Language, bool Enabled);
...
/// reflect the live, database-backed <c>ProviderSchedule</c> catalog record.
/// </summary>
