...
// `dotnet run --project src/ApiService -- --init-db` creates every Cosmos DB (Mongo API) collection/index
...
// nested JSON shape already used here for CosmosDb/NewsApiKeys secrets keep working as-is in
